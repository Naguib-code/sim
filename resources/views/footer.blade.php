<footer id="footer" class="bg-dark text-white py-5">
    <div class="container">
        ...
        <div class="col-lg-3 col-12">
            <h4>Système d'information medical</h4>
            <p class=" text-white-50">Nous sommes le service d'information medical</p>
        </div>
...
<p class="font-rale font-size-14">&copy; Copyrights 2020. Desing By <a href="#" class="color-second">SIM</a></p>
</div>
